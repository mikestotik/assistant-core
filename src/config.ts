...
const mainConfigPath = join(APP_ROOT_PATH, APP_CONFIG_DIR_NAME, APP_CONFIG_FILE_NAME);
const mainConfigYaml = fs.readFileSync(mainConfigPath, 'utf8');
const mainConfig = yaml.load(mainConfigYaml) as object;

const envConfigPath = join(APP_ROOT_PATH, APP_CONFIG_DIR_NAME, APP_ENV_CONFIG_FILE_NAME);
